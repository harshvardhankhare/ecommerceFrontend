...
import {
  ...
  ClockIcon,
  ShoppingBagIcon,
  XMarkIcon, MagnifyingGlassIcon, Bars3Icon
...
const [data,setData] = useState();
  ...
  const [categories] = useState([
    { id: 1, name: 'Electronics', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?w=500&auto=format&fit=crop', count: 245 },
    { id: 2, name: 'Fashion', image: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=500&auto=format&fit=crop', count: 189 },
    { id: 3, name: 'Home & Garden', image: 'https://images.unsplash.com/photo-1484101403633-562f891dc89a?w=500&auto=format&fit=crop', count: 156 },
    { id: 4, name: 'Beauty', image: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=500&auto=format&fit=crop', count: 98 },
    { id: 5, name: 'Sports', image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=500&auto=format&fit=crop', count: 76 },
    { id: 6, name: 'Books', image: 'https://images.unsplash.com/photo-1497636577773-f1231844b336?w=500&auto=format&fit=crop', count: 321 },
  ]);
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-800">Shop<span className="text-primary">Hub</span></span>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/deals" className="text-gray-700 hover:text-primary font-medium flex items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              {/* Wishlist */}
              {isLoggedIn ? (
                <Link to="/user/wishlist" className="text-gray-600 hover:text-primary relative">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-200 py-4">
              <div className="space-y-4">
                ...
                <Link to="/categories" className="block text-gray-700 hover:text-primary">Categories</Link>
                <Link to="/deals" className="block text-gray-700 hover:text-primary">Deals</Link>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {products.filter(p => p.isFeatured).map((product) => (
              <div key={product.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow group">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {products.filter(p => p.isNew).map((product) => (
              <div key={product.id} className="flex bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow group overflow-hidden">
                ...
                <div className="w-2/3 p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs text-primary bg-primary/10 px-2 py-1 rounded">NEW ARRIVAL</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><button onClick={() => navigate('/shop')} className="text-gray-400 hover:text-white">Shop</button></li>
                <li><button onClick={() => navigate('/categories')} className="text-gray-400 hover:text-white">Categories</button></li>
                <li><button onClick={() => navigate('/deals')} className="text-gray-400 hover:text-white">Today's Deals</button></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><button onClick={() => navigate('/help')} className="text-gray-400 hover:text-white">Help Center</button></li>
                <li><button onClick={() => navigate('/shipping')} className="text-gray-400 hover:text-white">Shipping Info</button></li>
                <li><button onClick={() => navigate('/returns')} className="text-gray-400 hover:text-white">Returns & Exchanges</button></li>
